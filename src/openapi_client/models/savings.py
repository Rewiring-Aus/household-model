...
class Savings(BaseModel):
    ...
    opex_before: Optional[OpexWeekly] = Field(default=None, alias="opexBefore")
    opex_after: Optional[OpexWeekly] = Field(default=None, alias="opexAfter")
    __properties = ["emissions", "opex", "upfrontCost", "recommendation", "opexBefore", "opexAfter"]
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of opex_before
        if self.opex_before:
            _dict['opexBefore'] = self.opex_before.to_dict()
        # override the default output from pydantic by calling `to_dict()` of opex_after
        if self.opex_after:
            _dict['opexAfter'] = self.opex_after.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: dict) -> Savings:
        ...
        _obj = Savings.parse_obj({
            ...
            "opex_before": OpexWeekly.from_dict(obj.get("opexBefore")) if obj.get("opexBefore") is not None else None,
            "opex_after": OpexWeekly.from_dict(obj.get("opexAfter")) if obj.get("opexAfter") is not None else None
        })
        return _obj
